...
const featuresData = [
  {
    ...
    icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-7 mt-2 ml-25 mb-4">
...
const Features = () => {
  ...
  />
      ...
      <section className=" relative -mt-155 text-center py-20 px-7">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Core Security Modules</h1>
        <p className="text-gray-400 max-w-xl mx-auto">
        Covering the most essential use cases needed by a fast growing startup.
        </p>
      </section>
