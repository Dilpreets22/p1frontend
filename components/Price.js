...
const Price = () => {
  ...
  <div className="container px-7 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      <h1 className="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-300">Simple Pricing. Powerful Security.</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">We want to ensure that cybersecurity is accessible without slowing down your growth journey.</p>
    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-2xl border-2 border-gray-300 flex flex-col relative overflow-hidden">
          ...
          <p className="flex items-center text-gray-600 mb-2">
            ...
            </span>All Security Modules Included
          </p>
          <p className="flex items-center text-gray-600 mb-2">
            <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
              <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
            ...
            </span>Each User can use upto 3 devices.
          </p>
          ...
          <p className="text-xs text-gray-500 mt-3">Comprehensive cybersecurity built for businesses that demand reliability, control, and peace of mind.</p>
        </div>
      </div>
      <div className="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div className="h-full p-6 rounded-2xl border-2 border-blue-500 flex flex-col relative overflow-hidden">
          ...
          <button className="flex items-center mt-auto text-white bg-blue-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-blue-600 rounded">Get Started
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-auto" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </button>
